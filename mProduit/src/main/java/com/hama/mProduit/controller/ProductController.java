package com.hama.mProduit.controller;
...
import com.hama.mProduit.configuration.ApplicationPropertiesConfiguration;
import com.hama.mProduit.exception.ProduitNotFoundException;
import com.hama.mProduit.model.Product;
import com.hama.mProduit.repository.ProductDao;
...
public class ProductController {
	...
	public List<Product> getProducts() {
		...
		logger.info("Récuperation de la liste des produits !");
		return listeLimitee;
	}
